...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">                
            <div class="box-body">
                <?php if(Session('add')) { ?><p class="top_add_btn"><a href="<?php echo URL::to('admin/adddeliveryboy'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i><?php echo trans('messages.Add New Deliveryboy'); ?></a></p><?php } ?>
                <div class="row">
                    <?php echo Form::open(array('url' => 'admin/filterdeliveryboy', 'method' => 'get')); ?>
