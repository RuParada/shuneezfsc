...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <?php if(Session::has('success')): ?><p class="success_msg"><?php echo Session::get('success'); ?><?php endif; ?>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">                
            <div class="box-body">
                ...
                <div class="row">
                    <?php echo Form::open(array('url' => 'admin/filterenquires', 'method' => 'get')); ?>
                            ...
                            foreach ($enquires as $enquiry) {
                                ...
                                <tr>
                                    ...
                                    <td class="action_btns" width="70">
                                            <a href="<?php echo URL::to('/admin/viewenquiry/'.$enquiry->id); ?>" class="edit_btn"><i class="fa fa-eye"></i></a>
