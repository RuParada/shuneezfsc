...
<html>
  <head>
    ...
    <link rel="icon" href="<?php echo URL::to('assets/images/favicon.ico'); ?>" type="image/x-icon" />
	...
	<?php echo Html::style('assets/admin/css/jquery-clockpicker.min.css'); ?>
    ...
    <?php echo Html::script('assets/admin/js/jquery-clockpicker.min.js'); ?>
        ...
        <nav class="navbar navbar-static-top" role="navigation">          
			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">  
					...
					<li><a href="<?php echo URL::to('admin/settings'); ?>" class="settings"><i class="fa fa-cog"></i> <?php echo trans('messages.Settings'); ?></a></li>
					...
					<!-- Menu Footer-->
						<li class="user-footer">
							<div class="pull-left">
								<a href="<?php echo URL::to('admin/settings'); ?>" class="btn btn-info sign_out"><?php echo trans('messages.Profile'); ?> </a>
							</div>
          ...
          <ul class="sidebar-menu">            
           ...
           <li class="treeview">
				...
				<ul class="treeview-menu">
					<!--<li><a href="<?php echo URL::to('admin/vendors'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Branches'); ?></a></li>-->
					<li><a href="<?php echo URL::to('admin/branches'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Branches'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/staffs'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Staffs'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/ingredients'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Ingredients'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/ingredientlist'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Ingredient Type'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/execlusions'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Execlusions'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/vendoritems'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Items'); ?></a></li>
				</ul>
			</li>
			<li class="treeview">
			...
			<?php if(Session('is_admin')) { ?><li><a href="<?php echo URL::to('admin/adminusers'); ?>"> <i class="fa fa-users"></i> <span><?php echo trans('messages.Manage Adminusers'); ?></span> </a></li><?php } ?>
			<li class="treeview">
				<a> <i class="fa fa-users"></i> <span><?php echo trans('messages.Manage Deliveryboys'); ?></span> <i class="fa fa-angle-left pull-right"></i> </a> 
				<ul class="treeview-menu">
					<li><a href="<?php echo URL::to('admin/deliveryboys'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Deliveryboys'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/track-deliveryboys'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Track Deliveryboys'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/deliveryboy-ratings'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Deliveryboy Ratings'); ?></a></li>
				</ul>
			</li>
			
			<li><a href="<?php echo URL::to('admin/addresstype'); ?>"> <i class="fa fa-users"></i> <span><?php echo trans('messages.Manage Address Type'); ?></span> </a></li>
			<li><a href="<?php echo URL::to('admin/orders'); ?>"> <i class="fa fa-shopping-cart"></i> <span><?php echo trans('messages.Manage Orders'); ?></span> </a></li>

			<li><a href="#"> <i class="fa fa-cogs"></i> <span><?php echo trans('messages.Manage Masters'); ?></span> <i class="fa fa-angle-left pull-right"></i> </a> 
				<ul class="treeview-menu">
					<li><a href="<?php echo URL::to('admin/promocodes'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Promocode'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/currencies'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Currency'); ?></a></li>
					<!--<li><a href="<?php echo URL::to('admin/citylist'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Cities'); ?></a></li>-->
				</ul>
			</li>
			<li><a href="#"> <i class="fa fa-cogs"></i> <span><?php echo trans('messages.Manage Languages'); ?></span> <i class="fa fa-angle-left pull-right"></i> </a> 
				<ul class="treeview-menu">
					<li><a href="<?php echo URL::to('admin/backend_languages'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Update Backend Languages'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/frontend_languages'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Update Frontend Languages'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/api_languages'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Update Api Languages'); ?></a></li>
				</ul>
			</li>
			...
			<li><a href="#"> <i class="fa fa-file-text-o"></i> <span><?php echo trans('messages.Manage Reports'); ?></span> <i class="fa fa-angle-left pull-right"></i> </a> 
				<ul class="treeview-menu">
					<li><a href="<?php echo URL::to('admin/branch_report'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Branch Sales'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/item_report'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Item Sales'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/sales_report'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Sales Report'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/deliveryboy_sales_report'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Deliveryboy Sales'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/branch_hour_report'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Branch Hour Report'); ?></a></li>
					<li><a href="<?php echo URL::to('admin/deliveryboy_hour_report'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Deliveryboy Hour Report'); ?></a></li>
				</ul>
			</li>
			<li><a href="<?php echo URL::to('admin/enquires'); ?>"> <i class="fa fa-envelope"></i> <span><?php echo trans('messages.Manage Enquires'); ?></span> </a></li>
			<li><a href="#"> <i class="fa fa-envelope"></i> <span><?php echo trans('messages.Integration'); ?></span> <i class="fa fa-angle-left pull-right"></i> </a> 
				<ul class="treeview-menu">
					...
					<ul class="treeview-menu">
						<li>
							<a href="<?php echo URL::to('admin/branch-integration'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Branch Mapping'); ?></a>
						</li>
						<li>
							<a href="<?php echo URL::to('admin/item_integration'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Item Mapping'); ?></a>
						</li>
						<li>
							<a href="<?php echo URL::to('admin/execlusion_integration'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Execlusion Mapping'); ?></a>
						</li>
					</ul>
					</li>
				</ul>
				<ul class="treeview-menu">
					...
					<ul class="treeview-menu">
						<li>
							<a href="<?php echo URL::to('admin/teams'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Dook Teams'); ?></a>
						</li>
						<li>
							<a href="<?php echo URL::to('admin/pickup-points'); ?>"><i class="fa fa-angle-right"></i><?php echo trans('messages.Pickup Points'); ?></a>
						</li>
					</ul>
					</li>
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li><a href="<?php echo URL::to('admin/notification/auto'); ?>"><i class="fa fa-angle-right"></i>Automatic Messages Configiration</a></li>
					<li><a href="<?php echo URL::to('admin/notification/send'); ?>"><i class="fa fa-angle-right"></i>Send Message Manually</a></li>
				</ul>
			</li>
		</ul>
        </section> <!-- /.sidebar -->
