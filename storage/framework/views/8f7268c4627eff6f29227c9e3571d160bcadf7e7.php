...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo trans('messages.Add User'); ?> </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    <?php echo Form::open(array('url' => 'admin/adduser', 'class' => 'form-horizontal', 'files' => 1)); ?>

                    <div class="box-body">
                        <div class="form-group">
                            <label for="first_name" class="col-sm-3 control-label"><?php echo trans('messages.First Name'); ?> <span class="req">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" maxlength='30' name="first_name" class="form-control" id="name" placeholder="<?php echo trans('messages.First Name'); ?> " value="<?php echo (Input::old('first_name')) ? Input::old('first_name') : ''; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" maxlength='30' name="last_name" class="form-control" id="name" placeholder="<?php echo trans('messages.Last Name'); ?> " value="<?php echo (Input::old('last_name')) ? Input::old('last_name') : ''; ?>">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy-o"></i><?php echo trans('messages.Save User'); ?></button>
                        <button type="reset" class="btn pull-right"><i class="fa fa-refresh"></i><?php echo trans('messages.Clear'); ?></button>
                        <button type="button" onclick="window.location.href = '<?php echo URL::to('admin/users'); ?>'" class="btn pull-right"><i class="fa fa-chevron-left"></i><?php echo trans('messages.Cancel'); ?></button>
                    </div><!-- box-footer -->
                    <?php echo Form::close(); ?>
