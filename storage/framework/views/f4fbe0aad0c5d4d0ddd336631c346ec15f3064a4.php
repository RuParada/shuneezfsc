   ...
   <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-dialog">
         <div class="loginmodal-container">
            ...
            <br>
            <?php if(Session::has('login_check')): ?><p class="lerror" style='color:red;'>  <?php echo Session::get('login_check'); ?></p> <?php endif; ?>
            ...
            <?php if(Session::has('login_error')): ?><span class="error_msg"> <?php echo ($login_error->first('username') != '') ? $login_error->first('username') : ''; ?></span><?php endif; ?>
            <input type="password" name="password" placeholder="<?php echo trans('frontend.Password'); ?>">
            <?php if(Session::has('login_error')): ?><span class="error_msg"> <?php echo ($login_error->first('password') != '') ? $login_error->first('password') : ''; ?></span><?php endif; ?>
   ...
   <div class="modal fade" id="signup-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-dialog">
         <div class="loginmodal-container">
            ...
            <h1>SIGNUP</h1>
            <br>
            <?php if(Session::has('signup_success')): ?><p class="lerror" style='color:red;'> <?php echo Session::get('signup_success'); ?> </p> <?php endif; ?>
            ...
            <?php if(Session::has('signup_error')): ?><span class="error_msg"> <?php echo ($error->first('first_name') != '') ? $error->first('first_name') : ''; ?></span><?php endif; ?>
            ...
            <?php if(Session::has('signup_error')): ?><span class="error_msg"> <?php echo ($error->first('last_name') != '') ? $error->first('last_name') : ''; ?></span><?php endif; ?>
            ...
            <?php if(Session::has('signup_error')): ?><span class="error_msg"> <?php echo ($error->first('email') != '') ? $error->first('email') : ''; ?></span><br><?php endif; ?>
            ...
            <?php if(Session::has('signup_error')): ?><span class="error_msg"> <?php echo ($error->first('mobile') != '') ? $error->first('mobile') : ''; ?></span><?php endif; ?>
            ...
            <?php if(Session::has('signup_error')): ?><span class="error_msg"> <?php echo ($error->first('password') != '') ? $error->first('password') : ''; ?></span><?php endif; ?>
