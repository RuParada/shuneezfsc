...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">                
            <div class="box-body">
                <?php if(Session('add')) { ?><p class="top_add_btn"><a href="<?php echo URL::to('admin/addfaq'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i><?php echo trans('messages.Add FAQ'); ?></a></p><?php } ?>
                <div class="row">
                    <?php echo Form::open(array('url' => 'admin/filterfaqs', 'method' => 'get')); ?>
