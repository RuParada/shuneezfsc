<?php if(Session::has('signup_error')): ?> <?php $error = Session::get('signup_error') ?> <?php endif; ?>
<?php if(Session::has('login_error')): ?> <?php $login_error = Session::get('login_error') ?> <?php endif; ?>
<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="utf-8">
      ...
      <?php echo Html::style('assets/css/rtl.css'); ?>

      <?php echo Html::style('assets/css/media_style_rtl.css'); ?>

      <?php } else { ?>
      <?php echo Html::style('assets/css/style.css'); ?>

      <?php echo Html::style('assets/css/media_style.css'); ?>
   ...
   <header>
      <div class="banner-section">
        <img src="<?php echo URL::to(($config_data['banner'] != '') ? 'assets/uploads/settings/'.$config_data['banner'] : 'assets/images/home-bg.png'); ?>" class="img-responsive banner_img">
        <div class="hme"> <!-- cont out -->
         <div class="container">
            <div class="hme-header">
               <div class="col-lg-7 col-md-5 col-sm-4 col-xs-12">
                  <a href="<?php echo URL::to(''); ?>"><img src="<?php echo URL::to('assets/images/Shuneez-logo.png'); ?>" class="img-responsive hme-logo"></a>
               </div>
                     ...
                     <ul class="my_acc_pos_rel">
                        ...
                        <li class="show_hide">
                           ...
                           <ul id='content' class="slidingDiv" style="display: none;">
                              <li><a href="<?php echo URL::to('edit_profile'); ?>"><?php echo trans('frontend.Edit Profile'); ?></a></li>
                        ...
                        <li><a href="<?php echo URL::to('logout'); ?>" ><?php echo trans('frontend.Logout'); ?></a></li>
                        <?php } ?>
                     </ul>
                  </div>
               </div>
            ...
            <?php echo Form::open(array('url' => 'getitems', 'id' => 'listing_form')); ?>
   ...
   <div class="mobile-section">
      ...
      <div class="container">
         <div class="col-md-5 col-xs-12">
            <img src="<?php echo URL::to('assets/images/mobile-banner.png'); ?>" class="img-responsive" style="margin:0 auto;">
         </div>
         <div class="col-md-7 col-xs-12">
            <div class="down-mobile">
               ...
               <div class="agn-mob">
                  <ul class="mob_a1">
                     <li class="mob_a2"><a href="#"><img src="<?php echo URL::to('assets/images/app-store.png'); ?>" class="img-responsive"></a></li>
                     <li><a href="#"><img src="<?php echo URL::to('assets/images/google-play.png'); ?>" class="img-responsive"></a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <div class="foot-sec">
         <div class="container">
            <div class="col-md-2 col-xs-12">
              <!-- <img class="foot_img" src="<?php echo URL::to('assets/images/payfort.png'); ?>">-->
            </div>
            ...
            <div class="col-md-2 col-xs-12">
               <div class="social-share">
                  <ul>
                     <li><a href="#"><img src="<?php echo URL::to('assets/images/footer-fb.png'); ?>" class="sicn"></a></li>
                     <li><a href="#"><img src="<?php echo URL::to('assets/images/footer-twitter.png'); ?>" class="sicn"></a></li>
                     <li><a href="#"><img src="<?php echo URL::to('assets/images/footer-gplus.png'); ?>" class="sicn"></a></li>
                     <li><a href="#"><img src="<?php echo URL::to('assets/images/footer-linkedin.png'); ?>" class="sicn"></a></li>
                  </ul>
               </div>
            </div>
            <div class="col-md-12 col-xs-12">
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css"> 
      ...
      $(document).ready(function()
         {
		  ...
		  source: '<?php echo e(URL('autocomplete_branch')); ?>',
		  minLength: 1,
   ...
   <?php echo Html::script('assets/js/datetimepicker.js'); ?>

   <?php echo Html::script('assets/admin/js/jquery-clockpicker.min.js'); ?>

   <?php echo Html::script('assets/js/custom-script.js'); ?>

   <!--<?php echo Html::script('assets/js/bootstrap-select.js'); ?>-->
