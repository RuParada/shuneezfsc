...
<div class="content-wrapper">
	...
	<div class="box">                
        <div class="box-body">
           <a href="{!! URL::to('admin/createorder')!!}" class="btn btn-primary"><i class="fa fa-plus-circle"></i><?php echo trans('messages.Create Order'); ?></a>
		   <table id="dataTable" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
						...
						<td>
							{!! Form::open(array('url' => 'admin/update_orderstatus')) !!}
                        ...
                        <td class="action_btns" width="120">
                            ...
                            <?php } else { ?>
                                <a href="{!! URL::to('/admin/assign_order/'.$order->id) !!}" title="Assign Order" class="view_btn"><i class="fa fa-sign-in"></i></a>
                            <?php } ?>
