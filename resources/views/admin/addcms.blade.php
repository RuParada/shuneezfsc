...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            {!! Form::open(array('url' => 'admin/addcms', 'class' => 'form-horizontal')) !!}
            <div class="col-md-8">

                <div class="box">

                    <div class="box-header with-border">
                        <h3 class="box-title">Fill the below fields</h3>
                    </div><!--box-header-->		
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="title" class="form-control" placeholder="Page Title " value="<?php echo Input::old('title'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="order" class="form-control" placeholder="Sort Order " value="<?php echo Input::old('order'); ?>">
                        ...
                        <div class="form-group product_desc">
                            ...
                            <div class="col-sm-12">
                                <textarea class="textarea" name="description" placeholder="Place some text here"><?php echo Input::old('description'); ?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="meta_title" class="form-control" placeholder="Meta Title " value="<?php echo Input::old('meta_title'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="meta_keyword" class="form-control" placeholder="Meta Keywords" value="<?php echo Input::old('meta_keyword'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="meta_description" class="form-control" placeholder="Meta Description" value="<?php echo Input::old('meta_description'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 radio_btns">
                                ...
                                <label><input type="radio" name="status" value="0" <?php echo (Input::old('status') == '0') ? 'checked' : ''; ?>>InActive</label>
                            </div>
                        </div>
                    </div><!--box-body--> 
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy-o"></i>Add Page</button>
