...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo trans('messages.Add Currency'); ?> </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    {!! Form::open(array('url' => 'admin/addcurrency', 'class' => 'form-horizontal')) !!}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="currency_name" class="col-sm-3 control-label"><?php echo trans('messages.Currency Name'); ?> <span class="req">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" maxlength='30' name="currency_name" class="form-control" id="currency_name" placeholder="<?php echo trans('messages.Currency Name'); ?> " value="<?php echo (Input::old('currency_name')) ? Input::old('currency_name') : ''; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" maxlength='5' name="currency_symbol" class="form-control" id="currency_symbol" placeholder="<?php echo trans('messages.Currency Symbol'); ?> " value="<?php echo (Input::old('currency_symbol')) ? Input::old('currency_symbol') : ''; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" maxlength='5' name="currency_code" class="form-control" id="currency_code" placeholder="<?php echo trans('messages.Currency Code'); ?>" value="<?php echo (Input::old('currency_code')) ? Input::old('currency_code') : ''; ?>">
                                @if(Session::has('error'))<p class="error_msg"><?php echo ($error->first('currency_code') != '') ? $error->first('currency_code') : ''; ?></p>@endif
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="currency_position" class="col-sm-3 control-label"><?php echo trans('messages.Currency Position'); ?> <span class="req">*</span></label>
                            <div class="col-sm-9 radio_btns">
                                <input type="radio" name="currency_position" value="l" checked><?php echo trans('messages.Left'); ?>
                                <input type="radio" name="currency_position" value="r" <?php echo (Input::old('currency_position') == '0') ? 'checked' : ''; ?>><?php echo trans('messages.Right'); ?>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9 radio_btns">
                                <input type="checkbox" name="default_currency" value="1" <?php echo (Input::old('default_currency') == '0') ? 'checked' : ''; ?>>
                            </div>
                        </div>
                    </div><!--box-body-->

                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy-o"></i><?php echo trans('messages.Save Currency'); ?></button>
