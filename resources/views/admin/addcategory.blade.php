...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><?php echo trans('messages.Add Category'); ?> </h1>
	</section>

	<!-- Main content -->
	<section class="content product">
	<div class="row margin0">
	{!! Form::open(array('url' => 'admin/addcategory', 'files' => 1)) !!}
					...
					<div class="box">
						...
						<div class="box-body col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="category[]" placeholder="<?php echo trans('messages.Enter category name'); ?>" value="<?php echo Input::old('category')[$i]; ?>">
	...
	<div class="box-footer">
		<button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy-o"></i><?php echo trans('messages.Save Category'); ?></button>
