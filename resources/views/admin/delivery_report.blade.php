...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><?php echo trans('messages.Deliveryboy Sales Report'); ?></h1>
	</section>
	...
	<div class="box">                
        ...
        {!! Form::close() !!}    
            <div class="row">
                    {!! Form::open(array('url' => 'admin/deliveryboy_sales_report', 'method' => 'get')) !!}
           ...
           <table id="dataTable" class="table table-bordered table-striped">
                <thead>
                    <tr>
						...
						<th><?php echo trans('messages.Delivery Boy'); ?></th>
