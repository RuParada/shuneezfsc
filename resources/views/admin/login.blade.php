  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        @if(Session::has('succ_msg'))<p class="success_msg"><?php echo Session('succ_msg'); ?></p>@endif     
        {!! Form::open(array('url' => 'admin/login')) !!}
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Username" name="username" value="<?php echo Input::old('username'); ?>">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            @if(Session::has('login_error'))<p class="error_msg"><?php echo ($error->first('username') != '') ? $error->first('username') : ''; ?></p>@endif
          </div>
          <div class="form-group has-feedback">
