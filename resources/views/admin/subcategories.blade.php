...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">                
            <div class="box-body">
                <?php if(Session('add')) { ?><p class="top_add_btn"><a href="{!! URL::to('admin/addsubcategory') !!}" class="btn btn-primary"><i class="fa fa-plus"></i><?php echo trans('messages.New Subcategory'); ?> </a></p><?php } ?>
                <div class="row">
                    {!! Form::open(array('url' => 'admin/filtersubcategories', 'method' => 'get')) !!}
