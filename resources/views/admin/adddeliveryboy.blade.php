...
<div class="content-wrapper">
	...
	{!! Form::open(array('url' => 'admin/adddeliveryboy', 'files' => 1)) !!}
	...
	<div class="box-footer">
		<input type="hidden" name="team_id" id="team_id" value="{!! Input::old('team_id') !!}">
		...
		<button type="button" onclick="window.location.href='{!! URL::to('admin/deliveryboys') !!}'" class="btn pull-right"><i class="fa fa-chevron-left"></i><?php echo trans('messages.Cancel'); ?></button>
    </div>
	{!! Form::close() !!}	
	</div> <!-- box -->
	</div>	
