    ...
    <div class="drag_main">
        ...
        <div class="drag_section">
            ...
            <ul class="drag_list no_drag" id="drag-right">
                ...
                <li>
                    <h4>{!! $item->item !!}</h4>
                    <input type="hidden" class="item_value" value="{!! $item->id !!}">
                    @if($item->foodics_id != '')
                        <span class="item_tag">{!! $item->foodics_id !!}<a class="remove" onclick="removeFoodics({!! $item->id !!});"><i class="fa fa-times-circle"></i></a></span>
                    @endif
					<a class="view"  onclick="viewdetails({!! $item->id !!}, 's');"><i class="fa fa-eye"></i></a>
                </li>
                @endforeach
            </ul> <!--drag_list-->
            @endif
