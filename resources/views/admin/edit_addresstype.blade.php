...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo trans('messages.Edit Address Type'); ?> </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    {!! Form::open(array('url' => 'admin/update_addresstype', 'class' => 'form-horizontal')) !!}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="addresstype" class="col-sm-3 control-label"><?php echo trans('messages.Address Type'); ?> <span class="req">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" maxlength='75' name="addresstype" class="form-control" id="addresstype" placeholder="<?php echo trans('messages.Address Type'); ?> " value="<?php echo (Input::old('addresstype')) ? Input::old('addresstype') : $addresstype->addresstype; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 radio_btns">
                                ...
                                <input type="radio" name="status" value="0" <?php echo (Input::old('status') == '0' || $addresstype->status == 0) ? 'checked' : ''; ?>><?php echo trans('messages.Inactive'); ?>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        <input type="hidden" name="id" value="<?php echo $addresstype->id; ?>">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy-o"></i><?php echo trans('messages.Update Address Type'); ?></button>
