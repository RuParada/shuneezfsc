...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">                
            <div class="box-body">
                <?php if(Session('add')) { ?><p class="top_add_btn"><a href="{!! URL::to('admin/addbranch') !!}" class="btn btn-primary"><i class="fa fa-plus"></i><?php echo trans('messages.Add New Branch'); ?></a></p><?php } ?>
                <div class="row">
                    {!! Form::open(array('url' => 'admin/filterbranches', 'method' => 'get')) !!}
