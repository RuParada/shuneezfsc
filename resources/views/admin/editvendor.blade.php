...
<div class="content-wrapper">
	...
	{!! Form::open(array('url' => 'admin/updatevendor', 'files' => 1)) !!}
		...
		<div class="col-md-12">
				<div class="box">
					...
					<div class="form-group full_selectList col-md-6">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="email" placeholder="<?php echo trans('messages.Email'); ?>" value="<?php echo $vendor->email; ?>">
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group full_selectList col-md-6">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="mobile" placeholder="<?php echo trans('messages.Mobile'); ?>" value="<?php echo $vendor->mobile; ?>">
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group full_selectList col-md-6">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="commission_percentage" placeholder="<?php echo trans('messages.Commision'); ?>" value="<?php echo $vendor->commission_percentage; ?>">
						</div>
					</div><!-- form-group -->
					</div><!-- box-body -->   
					...
					<div class="box-body">
						<div class="form-group full_selectList col-md-6">
							<div class="col-md-12" style='margin-bottom:10px;'>
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="street" placeholder="<?php echo trans('messages.Street'); ?>" value="<?php echo $vendor->street; ?>" id="street">
								</div>
							</div>
							<div class="col-md-12" style='margin-bottom:10px;'>
								<label class="col-sm-3 control-label"><?php echo trans('messages.City'); ?><span class="req">*</span> :</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="city" placeholder="<?php echo trans('messages.City'); ?>" value="<?php echo $vendor->city; ?>" id="city">
								</div>
							</div>
							<div class="col-md-12" style='margin-bottom:10px;'>
								<label class="col-sm-3 control-label"><?php echo trans('messages.Country'); ?>:<span class="req">*</span> :</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="country" placeholder="<?php echo trans('messages.Country'); ?>" value="<?php echo $vendor->country; ?>" id="country">
								</div>
							</div>
							<div class="col-md-12" style='margin-bottom:10px;'>
								<label class="col-sm-3 control-label"><?php echo trans('messages.Zipcode'); ?><span class="req">*</span> :</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="zipcode" placeholder="<?php echo trans('messages.Zipcode'); ?>" value="<?php echo $vendor->zipcode; ?>" id="zipcode">
									<input type="hidden" name="latitude" id="latitude" value="<?php echo $vendor->latitude; ?>">
									<input type="hidden" name="longitude" id="longitude" value="<?php echo $vendor->longitude; ?>">
								</div>
							</div>
						</div><!-- form-group -->
					...
					<div class="form-group upload_image col-sm-6">
						...
						<label for="upload_img" class="upload_lbl">
							<img src="{!! URL::to(($vendor->image != '') ? 'assets/uploads/vendors/'.$vendor->image : 'assets/admin/images/not-found.png') !!}" class="roundedimg">
						</label>
					...
					<div class="form-group full_selectList col-md-6">
						...
						<div class="col-sm-8">
							<select class="selectLists" name="status">
								...
								<option value="0" <?php echo (Input::old('status') == '0' || $vendor->status == 0) ? 'selected' : ''; ?>><?php echo trans('messages.Inactive'); ?></option>
							</select>
