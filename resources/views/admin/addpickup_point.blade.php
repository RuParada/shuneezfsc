        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    {!! Form::open(array('url' => 'admin/create-pickup-point', 'class' => 'form-horizontal')) !!}
                    <div class="box-body">
                    	<div class="form-group full_selectList">
                            ...
                            <div class="col-sm-9">
                                <select class="selectLists" name="team_id" id="team">
                                    <option value="">{!! trans('messages.Select Team') !!}</option>
                                    @if ( count($teams) )
	                                    @foreach($teams as $team)
	                                        <option value="{!! $team->dook_id !!}" {!! ($team->dook_id == Input::old('team_id')) ? 'selected' : '' !!}>{!! $team->name !!}</option>
	                                    @endforeach
                                	@endif
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if(Session::has('error'))<p class="error_msg"><?php echo ($error->first('contact_name') != '') ? $error->first('contact_name') : ''; ?></p>@endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if(Session::has('error'))<p class="error_msg"><?php echo ($error->first('phone') != '') ? $error->first('phone') : ''; ?></p>@endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @if(Session::has('error'))<p class="error_msg"><?php echo ($error->first('latitude') != '') ? $error->first('latitude') : ''; ?></p>@endif
                                </div>
                            </div><!-- form-group -->
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @if(Session::has('error'))<p class="error_msg"><?php echo ($error->first('longitude') != '') ? $error->first('longitude') : ''; ?></p>@endif
                                </div>
                            </div><!-- form-group -->
                    </div><!--box-body-->

                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy-o"></i><?php echo trans('messages.Save Pickup Point'); ?></button>
