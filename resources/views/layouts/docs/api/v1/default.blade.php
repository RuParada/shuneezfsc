            ...
            <div class="row">
                <div class="col-3" id="sidebar">
                    <div class="column-content">
                        <div class="search-header">
                            <img src="vendor/f2m2/apidocs/src/templates/assets/img/f2m2_logo.svg" class="logo" alt="Logo" />
                        ...
                        <ul id="navigation">
                            ...
                            <li>
                                <a href="#User">User</a>
                                <ul>
									<li><a href="#User_getuser">getuser</a></li>

									<li><a href="#User_getusers">getusers</a></li>

									<li><a href="#User_adduser">adduser</a></li>
</ul>
                            </li>
                ...
                <div class="col-9" id="main-content">
                    ...
                    <div class="column-content">
                        ...
                        <a href="#" class="waypoint" name="User_getuser"></a>
                       ...
                       <!--  <div class="parameter-header">
                        ...
                        <form class="api-explorer-form" uri="api/v1/user/{id}" type="GET">
                       ...
                       <!--  <div class="parameter-header">
                        ...
                        <a href="#" class="waypoint" name="User_adduser"></a>
                        <div class="endpoint-header">
                            <ul>
                            <li><h2>POST</h2></li>
                            <li><h3>adduser</h3></li>
