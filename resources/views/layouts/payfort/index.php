...
?>
    ...
    <section class="order-info">
        ...
        <ul class="price">
            ...
            <li><span class="curreny">SAR</span> <?php echo round(sprintf("%.2f",$_SESSION['total']));?>	</li>
        </ul>
    </section>
        ...
        <ul>
            <li>
                ...
                <label class="payment-option active" for="po_creditcard">
                    <img src="assets/payfort/img/cc.png" alt="">
            ...
            <li>
                ...
                <label class="payment-option" for="po_installments">
                    <img src="assets/payfort/img/installment.png" alt="">
            ...
            <li>
                ...
                <label class="payment-option" for="po_naps">
                    <img src="assets/payfort/img/naps.png" alt="">
            ...
            <li>
                ...
                <label class="payment-option" for="po_sadad">
                    <img src="assets/payfort/img/sadaad.png" alt="">
    ...
    <section class="actions">
        <a class="back" href="<?php echo URL::to('checkout'); ?>">Back</a>
        <a class="continue" id="btn_continue" href="javascript:void(0)">Continue</a>
    </section>
    <script type="text/javascript" src="assets/js/jquery.min.js"></script>
        <script type="text/javascript" src="assets/payfort/js/jquery.creditCardValidator.js"></script>
        <script type="text/javascript" src="assets/payfort/js/checkout.js"></script>
