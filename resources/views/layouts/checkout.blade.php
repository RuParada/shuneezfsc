...
<div class="tab-pane" id="2">
          <div class="container comm1">
            ...
            <div class="clr_1"></div>
            <div class="col-md-6 pad4">
              <label><?php echo trans('frontend.Mobile'); ?><span class="req">*</span></label>
              <input type="text" class="ck_out_field" name="mobile" value="<?php echo Input::old('mobile'); ?>">
 ...
 <table>
    <tr>
		<td>
         ...
         <td>
            <input type="radio" name="payment_type" id="cod" value="0" class="css-checkbox-radio" <?php echo (Input::old('payment_type') == '0') ? 'checked' : ''; ?>/>
...
{
var latitude = '<?php echo (Input::old('latitude') != '') ? Input::old('latitude') : 11.0168; ?>';
var longitude = '<?php echo (Input::old('longitude') != '') ? Input::old('longitude') : 76.9558; ?>';
