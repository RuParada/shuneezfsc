...
<html>
  <head>
    ...
    {!! Html::style('assets/admin/css/bootstrap3-wysihtml5.min.css') !!}
        ...
        <nav class="navbar navbar-static-top" role="navigation">          
			...
			<div class="navbar-custom-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="footer"><a href="{!! URL::to('notifications') !!}">View All Notifications</a></li>
                </ul>
              </li>	-->			
			<?php } ?>
					<li><a href="{!! URL::to('admin/settings') !!}" class="settings"><i class="fa fa-cog"></i> Settings</a></li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">            
           ...
           <li class="treeview">
				<a> <i class="fa fa-users"></i> <span><?php echo trans('messages.Manage Vendors'); ?></span> <i class="fa fa-angle-left pull-right"></i> </a> 
				<ul class="treeview-menu">
					<li><a href="{!! URL::to('admin/vendors') !!}"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Vendors'); ?></a></li>
					<li><a href="{!! URL::to('admin/branches') !!}"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Branches'); ?></a></li>
					<li><a href="#"><i class="fa fa-angle-right"></i><?php echo trans('messages.Manage Ingredients'); ?></a></li>
				</ul>
			</li>
			<li class="treeview">
			...
			<li><a href="{!! URL::to('admin/cuisines') !!}"> <i class="fa fa-cutlery"></i> <span><?php echo trans('messages.Manage Cuisines'); ?></span> </a></li>
			<li class="treeview">
			...
			<li><a href="{!! URL::to('admin/deliveryboys') !!}"> <i class="fa fa-users"></i> <span><?php echo trans('messages.Manage Deliveryboys'); ?></span> </a></li>
