...
{!! Form::open(array('url' => 'additem', 'id' => 'ingredient_form')) !!} 
<div class="modal-bdy1">
    ...
    top: 3px;">
        ...
        <div class="col-md-4">
          <div class="n"><img src="{!! URL::to('assets/uploads/vendor_items/'.$vendor_item->image) !!}" style="width:100%;position: absolute;float: left;height: 100%;"></div>
