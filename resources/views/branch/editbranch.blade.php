...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><?php echo trans('messages.Update Profile'); ?> </h1>
		@if(Session::has('success')) <p class="success_msg"> <?php echo Session('success'); ?></p> @endif
	</section>

	<!-- Main content -->
	<section class="content product">
	<div class="row margin0">
	{!! Form::open(array('url' => 'branch/updatebranch', 'files' => 1, 'id' => 'branch_form')) !!}
