		...
		<div class="col-md-4">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number"><small><?php echo getdefault_currency(); ?></small> <?php echo $sale['overall']; ?></span>
		...
		<div class="col-md-4">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number"><small><?php echo getdefault_currency(); ?></small> <?php echo $sale['today']; ?></span>
				</div><!-- info-box-content -->
			</div><!-- info-box -->
		</div>	
		...
		<div class="col-md-4">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number"><small><?php echo getdefault_currency(); ?> </small> <?php echo $sale['month']; ?></span>
				</div><!-- info-box-content -->
			</div><!-- info-box -->
		</div>
	</div> <!-- row --> 
                  ...
                  <div class="table-responsive latest_orders">
                    <table class="table no-margin table-bordered">
                      ...
                      <tbody>
                        ...
                        <?php $i++; } } else { ?>
							<tr>
								<td colspan="5" align="center"><?php echo trans('messages.No data found'); ?></td>
							</tr>
						<?php } ?>
                        </tbody>
                    </table>
