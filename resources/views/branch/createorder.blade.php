...
<section class="content">
  {!! Form::open(array('url' => 'branch/createorder')) !!}      
    ...
    <div class="box">
      ...
      <div class="box-body" >
        ...
        $size = ($item->options->is_size) ? ' - '.$item->options->size : '';
            ...
            <div class="pro_price_1">
              <span class="pro_title_txt_2" id="delivery_fee"><?php echo $branch->delivery_fee; ?></span>
            </div>				
            <div class="pro_price_1">
              <span class="pro_title_txt_2">
                <?php echo $vat_tax; ?>
  ...
  <div class="box-footer feeback_btns">
    ...
    <button type="button" onclick="window.location.href = '{!! URL::to('branch/orders') !!}'" class="btn pull-right">
